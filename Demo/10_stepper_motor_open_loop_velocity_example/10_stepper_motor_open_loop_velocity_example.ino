// MKS MINI FOC 步进电机 开环速度控制例程 测试库：SimpleFOC 2.1.1 测试硬件：MKS MINI FOC V1.0
...
StepperDriver4PWM driver = StepperDriver4PWM(32, 33, 26, 27, 22, 21); // M0_A:A+ M0_B:A- M1_A:B+ M1_B:B- 
